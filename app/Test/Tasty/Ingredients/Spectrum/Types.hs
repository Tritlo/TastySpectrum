...
data Label = Label
    { loc_group :: !Int
    -- ^ Index of the module this label belongs to.
    , loc_pos :: !(Int, Int, Int, Int)
    -- ^ Source Code position of the given mix index, usually translates to something like 4:6-5:11 (from L4 Column 6 to L5 Column 11)
    , loc_index :: !Int
    -- ^ The index of the expression in our .csv-file. This is used as a unique identifier.
    , loc_info :: ![String]
    -- ^ A list of types then identifiers associated with the loc
    , loc_evals :: !(IntMap Integer)
    -- ^ A list of tests and how often this position has been evaluated
...
pprLabel ::
    -- | an IntMap of the Module ID's and their name
    IM.IntMap String ->
    -- | the label to be pretty printed
    Label ->
    -- | Pretty printed, human readable output matching an HPC Position
    String
